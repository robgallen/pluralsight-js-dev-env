...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_userApi__ = __webpack_require__(0);


__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_userApi__["a" /* getUsers */])().then(result => {
	let usersBody = "";
